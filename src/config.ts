export const SITE_URL = 'https://statasphere.co.uk'

export const CONTACT_EMAIL = 'statasphere@statasphere.app'
...
/** Open Graph image: public/og-image.jpg, extracted from the marketing film. */
